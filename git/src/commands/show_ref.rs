...
/// 'directory': directorio del repositorio local.
fn visit_refs_dirs(refs_path: String, formatted_result: &mut String, directory: &str) -> Result<(), GitError> {
...
mod tests {
    ...
    fn test_show_ref() {
        ...
        create_file_replace(&file_head, "18782jhbdshiu299wue2901hsd02wi982hoq8910").expect("Error al crear el archivo");
        ...
        create_file_replace(&file_remote, "sjlk28989d8io02100w8uo8iwendof32e33ewr03").expect("Error al crear el archivo");
        ...
        create_file_replace(&file_tag, "2309kh489982094hoif8402jk48209jh843f4392").expect("Error al crear el archivo");
