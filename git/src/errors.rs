...
impl GitError {
    ...
    pub fn message(&self) -> &str {
        match self {
            ...
            GitError::AlreadyOnThatBranch => "Ya estas en esa rama!",
            ...
            GitError::BranchFileReadError => "No se pudo leer el archivo de la branch.",
            ...
            GitError::InvalidArgumentCountLsFilesError => "Número de argumentos inválido para el comando ls-files.\nUsar: git ls-files o git ls-files <flag>",
            GitError::FlagLsFilesNotRecognizedError => "Flag no reconocida para el comando ls-files",
            GitError::InvalidArgumentCountLsTreeError => "Número de argumentos inválido para el comando ls-tree.\nUsar: git ls-tree o git ls-tree <tree-hash>",
            GitError::InvalidTreeHashError => "fatal: not a tree object",
            GitError::InvalidArgumentShowRefError => "Número de argumentos inválido para el comando show-ref.\nUsar: git show-ref",
            GitError::InvalidArgumentCountCheckIgnoreError => "Número de argumentos inválido para el comando check-ignore.\nUsar: git check-ignore <path name> o git check-ignore --stdin",
