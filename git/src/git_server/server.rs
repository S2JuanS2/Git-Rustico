...
// use crate::{git_transport::{references::Reference, advertised::AdvertisedRefLine}, consts::VERSION_DEFAULT, util::{pkt_line, connections::send_message}};

// use super::errors::GitServerError;
...
//     /// o un error de `GitServerError` si ocurre algún problema durante el proceso.
//     ///
//     pub fn new(content: &Vec<Vec<u8>>) -> Result<GitServer, GitServerError> {
...
//     /// o un error de `GitServerError` si ocurre algún problema durante el proceso.
//     ///
//     fn from_classified(classified: Vec<AdvertisedRefLine>) -> Result<GitServer, GitServerError> {
...
//     ) -> Result<GitServer, GitServerError> {
...
//     pub fn send_references(&self, writer: &mut dyn Write) -> Result<(), GitServerError> {
//         // Send version
...
//             send_message(writer, &reference, GitServerError::ReferencesObtaining)?;
//         }
...
//         //     send_message(writer, shallow, GitServerError::ReferencesObtaining)?;
//         // }

//         send_flush(writer, GitServerError::FlushNotSentDiscoveryReferences)?;
//         Ok(())
//     }
